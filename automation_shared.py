...
def setup_driver(headless_preference: Optional[bool] = None) -> webdriver.Chrome:
    ...
    # Set page load strategy to 'eager' - waits for DOM ready but not all resources
    # This is more stable than 'none' which was causing ChromeDriver crashes
...
def go_to_attendance(driver: webdriver.Chrome, wait: WebDriverWait, progress_callback=None) -> None:
    """Navigate to attendance page using button clicks only (no direct URL navigation)."""
    try:
        # Wait for page to stabilize after login
        print("Waiting for page to load after login...")
        time.sleep(5)

        # Switch to default content to ensure we're in the right context
        driver.switch_to.default_content()

        # Find and click the attendance button
        ...
        print("Attendance button found and clickable.")
        ...
        time.sleep(3)
        print("Navigated to attendance page via button click.")
